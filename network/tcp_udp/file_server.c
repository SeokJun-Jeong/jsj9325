//file_server.txt에 문자를 receive.txt에 복사
#include <arpa/inet.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main(int argc, char *argv[])
{
    ...
    fp = fopen("/home/seokjun/kubig2025/network/tcp_udp/file_server.txt", "rb");
    ...
    // shutdown(clnt_sock, SHUT_RD);       //recvQ의 흐름을 방해한다
    shutdown(serv_sock, SHUT_RD);          //서버의  recvQ는 클라이언트 패킷 전달에 상관 x
