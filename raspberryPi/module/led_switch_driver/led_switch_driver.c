//작성했지만 작동 x answer보기
// //read switch정보 얻기, write led 조작 드라이버
...
//     for (i = 0; i < 4; ++i)
//     {
//         ret = gpio_request(sw[i], "led switch");
//         if (ret < 0)
//             printk(KERN_INFO "led switch driver %d request fail!\n", i);
//     }
//     return 0;
// }
...
//     if (ret < 0)
//     {
//         printk(KERN_INFO "led_swtich driver copy to user fail\n");
//     }
...
//     for (i = 0; i < 4; ++i)
//     {
//         ret = gpio_direction_output(sw[i], cbuf[i]);
//         if (ret < 0)
//             printk(KERN_INFO "led switch driver %d direction output fail!\n", i);
//     }
//     return 0;
// }
...
dmesg
ls /dev
sudo mknod /dev/led_switch_driver1 c 223 0
sudo chmod 666 /dev/led_switch_driver1
*/
...
int sw[4] = {4 + 512, 17 + 512, 27 + 512, 22 + 512};
int led[4] = {23 + 512, 24 + 512, 25 + 512, 1 + 512};   //이거안적음
